...
function createEffectAdvanceLayer(nIndex)
{
	switch(nIndex)
	{
...
function nextEffectAdvanceAction()
{
	sceneIdx++;
...
function backEffectAdvanceAction()
{
	sceneIdx--;
	var total = MAX_LAYER;
	if( sceneIdx < 0 )
...
function restartEffectAdvanceAction()
{
	var pLayer = createEffectAdvanceLayer(sceneIdx);
...
class Effect1 : EffectAdvancedTextLayer
{
	constructor()
	{
		...
		var target = getChildByTag(kTagBackground)
...
class Effect3 : EffectAdvancedTextLayer
{
	constructor()
	{
		...
		var bg = getChildByTag(kTagBackground)
		var target1 = bg.getChildByTag(kTagSprite1)
		var target2 = bg.getChildByTag(kTagSprite2)
...
class Effect5 : EffectAdvancedTextLayer
{
	constructor()
	{
		...
		var stopEffect = cc.action.Sequence(effect, cc.action.DelayTime(2),
											cc.action.StopGrid())
...
class Issue631 : EffectAdvancedTextLayer
{
	constructor()
	{
		...
		var effect = cc.action.Sequence(cc.action.DelayTime(2),
