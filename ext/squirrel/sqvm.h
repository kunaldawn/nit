...
public:
	...
	bool Set(const SQObjectPtr &self, const SQObjectPtr &key, const SQObjectPtr &val, bool raw, SQInteger selfidx);
	...
	bool NewProp(const SQObjectPtr& self, const SQObjectPtr& name, const SQObjectPtr& getter, const SQObjectPtr& setter);
	...
	SQInteger ToRawID(const SQObjectPtr &o);
	...
	enum MetaMethodResult { META_SUCCESS, META_NOT_FOUND, META_ERROR };
	MetaMethodResult CallMetaMethod(SQDelegable *del, SQMetaMethod mm, SQInteger nparams, SQObjectPtr &outres);
...
////////////////////////////////////////////////////////////////////////////
	...
	void Insert(SQInteger n, SQInteger count);
	...
	SQInteger _stackbase;
	SQOuter	*_openouters;
	SQObjectPtr _threadname;
	SQObjectPtr _threadlocal;
	bool _nativeException;
	SQObjectPtr _lasterror;
	SQObjectPtr _errorhandler;
	SQREQUIREHANDLER _requirehandler;

	bool _debughook;
	SQDEBUGHOOK _debughook_native;
	SQUserPointer _debughook_native_up;
