...
#	include "nit/async/Mutex_win32.h"
...
class NIT_API Mutex: private MutexImpl
...
class NIT_API FastMutex: private FastMutexImpl
...
{
public:
	typedef nit::ScopedLock<FastMutex> ScopedLock;
