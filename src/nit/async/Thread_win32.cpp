...
ThreadImpl::ThreadImpl():
	...
	_stackSize(NIT_THREAD_STACK_SIZE)
{
}
...
#endif
	if (!_thread)
		NIT_THROW_FMT(EX_SYSTEM, "cannot create thread");
...
// functions setting-up ThreadName (for debugger display)
...
#endif
{
	...
	try
	{
		SetThreadName(-1, Thread::current()->name().c_str());
