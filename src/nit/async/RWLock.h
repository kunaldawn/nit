...
#	include "nit/async/RWLock_win32.h"

#elif defined(NIT_THREAD_POSIX)
#	include "nit/async/RWLock_posix.h"
#endif
...
class NIT_API RWLock: private RWLockImpl
...
class NIT_API ScopedReadRWLock : public ScopedRWLock
...
class NIT_API ScopedWriteRWLock : public ScopedRWLock
