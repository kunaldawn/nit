...
RWLockImpl::RWLockImpl(): _readers(0), _writersWaiting(0), _writers(0)
{
	...
	if (_mutex == NULL)
		NIT_THROW_FMT(EX_SYSTEM, "cannot create reader/writer lock");
...
inline void RWLockImpl::addWriter()
{
	...
	case WAIT_OBJECT_0:
		...
		break;
	default:
		NIT_THROW_FMT(EX_SYSTEM, "cannot lock reader/writer lock");
	}
}
...
void RWLockImpl::unlockImpl()
{
	...
	case WAIT_OBJECT_0:
		...
		break;
	default:
		NIT_THROW_FMT(EX_SYSTEM, "cannot unlock reader/writer lock");
	}
}
